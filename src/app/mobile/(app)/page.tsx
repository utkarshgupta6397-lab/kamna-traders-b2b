      ...
      <main className="flex-1 px-6 py-6 max-w-[430px] mx-auto w-full">
        ...
        <div className="grid grid-cols-2 gap-4 max-w-[300px] mx-auto">
          <Link
            ...
            className="flex flex-col justify-between aspect-square bg-white p-4 rounded-[20px] shadow-sm border border-slate-200 active:scale-[0.96] active:bg-slate-50 transition-all"
          >
            <div className="w-[52px] h-[52px] rounded-[16px] bg-blue-50 flex items-center justify-center mb-auto border border-blue-100/50">
              <svg width="30" height="30" viewBox="0 0 24 24" fill="none" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span className="font-bold text-slate-800 text-[17px] tracking-tight leading-none mt-4 text-left">
              Operations
            </span>
          </Link>
          ...
          <Link
            ...
            className="flex flex-col justify-between aspect-square bg-white p-4 rounded-[20px] shadow-sm border border-slate-200 active:scale-[0.96] active:bg-slate-50 transition-all"
          >
            <div className="w-[52px] h-[52px] rounded-[16px] bg-green-50 flex items-center justify-center mb-auto border border-green-100/50">
              <svg width="30" height="30" viewBox="0 0 24 24" fill="none" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
