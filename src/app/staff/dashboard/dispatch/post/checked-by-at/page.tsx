...
import { Search, Filter, RefreshCw, ClipboardCheck } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-gray-100 bg-gray-50/50">
        <h1 className="text-xl font-bold text-gray-900">Checked By / At</h1>
        <p className="text-sm text-gray-500 mt-1">Upload supporting documents and record Checked By and Checked At details.</p>
      </div>
      ...
      <div className="flex-1 overflow-auto bg-gray-50/30 flex items-center justify-center p-8">
        <div className="flex flex-col items-center text-center max-w-md">
          ...
          <h3 className="text-lg font-bold text-gray-900">No invoices are awaiting Checked By / At details.</h3>
