...
export default function DocumentationDashboardKPIs({ summary, onFilterChange, activeFilter }: DocumentationDashboardKPIsProps) {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2.5">
      {/* Total Orders Card */}
      <div 
        className={`bg-white rounded-lg border p-2 cursor-pointer transition-all flex items-center gap-2.5 ${
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <h3 className="text-[9px] font-semibold text-gray-500 uppercase tracking-wider mb-0.5">Total Orders</h3>
          <div className="flex items-baseline gap-1.5">
            <p className="text-base font-bold text-gray-900 leading-none">{summary.total}</p>
            <p className="text-[8.5px] text-gray-400 truncate">In Doc Pipeline</p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <h3 className="text-[9px] font-semibold text-gray-500 uppercase tracking-wider mb-0.5">Completed</h3>
          <div className="flex items-baseline gap-1.5">
            <p className="text-base font-bold text-emerald-600 leading-none">{summary.completed}</p>
            <p className="text-[8.5px] text-gray-400 truncate">Ready</p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <h3 className="text-[9px] font-semibold text-gray-500 uppercase tracking-wider mb-0.5">In Progress</h3>
          <div className="flex items-baseline gap-1.5">
            <p className="text-base font-bold text-blue-600 leading-none">{summary.inProgress}</p>
            <p className="text-[8.5px] text-gray-400 truncate">Active</p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <h3 className="text-[9px] font-semibold text-gray-500 uppercase tracking-wider mb-0.5">Review</h3>
          <div className="flex items-baseline gap-1.5">
            <p className="text-base font-bold text-orange-500 leading-none">{summary.pendingReview}</p>
            <p className="text-[8.5px] text-gray-400 truncate">Pending</p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <h3 className="text-[9px] font-semibold text-gray-500 uppercase tracking-wider mb-0.5">Overdue</h3>
          <div className="flex items-baseline gap-1.5">
            <p className="text-base font-bold text-red-600 leading-none">{summary.overdue}</p>
            <p className="text-[8.5px] text-gray-400 truncate">&gt; 3 days</p>
          </div>
        </div>
      </div>

      {/* Average Completion Time */}
      <div className="bg-white rounded-lg border border-gray-200 p-2 flex items-center gap-2.5">
        <div className="p-1.5 bg-purple-50 text-purple-600 rounded-md shrink-0">
          <Timer size={12} />
        </div>
        <div className="min-w-0 flex-1">
          <h3 className="text-[9px] font-semibold text-gray-500 uppercase tracking-wider mb-0.5">Avg. Time</h3>
          <div className="flex items-baseline gap-1.5">
            <p className="text-base font-bold text-gray-900 leading-none">{summary.averageCompletionTime}</p>
            <p className="text-[8.5px] text-gray-400 truncate">To complete</p>
          </div>
        </div>
      </div>
    </div>
