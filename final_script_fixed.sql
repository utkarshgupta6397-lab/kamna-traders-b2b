...
-- AlterTable
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS     "catalog_brands_approve" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_brands_create" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_brands_modify" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_categories_approve" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_categories_create" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_categories_modify" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_hsncodes_approve" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_hsncodes_create" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_hsncodes_modify" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_manufacturers_approve" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_manufacturers_create" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_manufacturers_modify" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_product_attributes_archive" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_product_attributes_create" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_product_attributes_modify" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_products_approve" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_products_archive" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_products_create" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_products_modify" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_taxrates_approve" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_taxrates_create" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_taxrates_modify" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_units_approve" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_units_create" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "catalog_units_modify" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN IF NOT EXISTS     "system_productMigration" BOOLEAN NOT NULL DEFAULT false;

-- AlterTable
ALTER TABLE "Brand" ADD COLUMN IF NOT EXISTS     "approvedAt" TIMESTAMP(3),
...
-- AlterTable
ALTER TABLE "Category" ADD COLUMN IF NOT EXISTS     "approvedAt" TIMESTAMP(3),
ADD COLUMN IF NOT EXISTS     "approvedById" TEXT,
ADD COLUMN IF NOT EXISTS     "code" TEXT,
ADD COLUMN IF NOT EXISTS     "createdById" TEXT,
ADD COLUMN IF NOT EXISTS     "description" TEXT,
