...
import { Search, Filter, RefreshCw, FileSignature } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-gray-100 bg-gray-50/50">
        <h1 className="text-xl font-bold text-gray-900">Invoice Confirmation</h1>
        <p className="text-sm text-gray-500 mt-1">Confirm invoice completion for eligible Dispatch Sales Orders.</p>
      </div>
      ...
      <div className="flex-1 overflow-auto bg-gray-50/30 flex items-center justify-center p-8">
        <div className="flex flex-col items-center text-center max-w-md">
          ...
          <h3 className="text-lg font-bold text-gray-900">No Sales Orders are awaiting invoice confirmation.</h3>
