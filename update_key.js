        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prisma.gatewayConfiguration.findUnique({
                            where: { id: 'singleton' }
                        })];
                case 1:
                    config = _a.sent();
                    if (!config) return [3 /*break*/, 3];
                    return [4 /*yield*/, prisma.gatewayConfiguration.update({
                            where: { id: 'singleton' },
                ...
                return [4 /*yield*/, prisma.gatewayConfiguration.create({
                        data: {
                            id: 'singleton',
